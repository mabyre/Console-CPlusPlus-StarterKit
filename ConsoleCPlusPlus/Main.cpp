...
#define APP_TITLE L"Console Test application"
...
\*--------------------------------------------------------------------------*/
#ifndef NDEBUG
    TCHAR szTitle[MAX_PATH] = APP_TITLE " - Debug";
#else
    TCHAR szTitle[MAX_PATH] = APP_TITLE " - Release";
#endif
   ...
   while (1)
   {
      theHWnd = FindWindow(L"ConsoleWindowClass", szTitle);
      if (theHWnd == 0)
      {
         i++;
         if (i == 20)
