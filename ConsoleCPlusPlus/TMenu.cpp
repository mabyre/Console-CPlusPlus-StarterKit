...
static void DoItem3( const char* aParam )
{
...
static void DoSousMenuItem1( const char* aParam )
{
   c_printf( "Sous Menu Item 1 (%s).\n", aParam );
}

/*---------------------------------------------------------------------------*/

static void DoSousMenuItem2( const char* aParam )
{
    c_printf( "Sous Menu Item 2 (%s).\n", aParam );
}
