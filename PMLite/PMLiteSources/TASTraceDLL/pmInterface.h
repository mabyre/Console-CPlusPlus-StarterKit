...
#define pm_malloc(x)     c_malloc_dbg(x, __FILE__, __LINE__)
#define pm_free          c_free_dbg
#define pm_realloc(x, y) c_realloc_dbg(x, y, __FILE__, __LINE__)

#define pm_xmemdbg_dump_state c_xmemdbg_dump_state
#define pm_xmemdbg_set_max    c_xmemdbg_set_max
#define pm_xmemdbg_check      c_xmemdbg_check
...
#define pm_xthread_term c_xthread_term_imp
#define pm_xthread_init c_xthread_init_imp
