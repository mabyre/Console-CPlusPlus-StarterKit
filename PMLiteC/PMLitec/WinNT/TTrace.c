...
PMMENU_BEGIN(Trace, "Trace - Tests")
    ...
    PMMENU_ITEM_EX(3, "Set max mem", DoSetMaxMem)
    PMMENU_ITEM_EX(4, "Allocate block", DoAllocBlock)
    PMMENU_ITEM_EX(5, "Test CheckMem", DoTestCheckMem)
    PMMENU_ITEM_SEPARATOR("-----------------")
    PMMENU_ITEM_EX(6, "Traces test", DoTestTrace)
    PMMENU_ITEM_EX(7, "Strings", DoTestStrings)
    PMMENU_ITEM_EX(8, "itoa", DoTestIToA)
PMMENU_END()
